...
This outlines how to propose a change to astronomy. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("mitchelloharawild/astronomy", fork = TRUE)`.
...
Code of
Conduct](https://pkg.mitchelloharawild.com/astronomyengine/dev/CODE_OF_CONDUCT.md).
