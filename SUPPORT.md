...
Thanks for using astronomy! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/mitchelloharawild/astronomy/issues/new).
...
requests](https://github.com/mitchelloharawild/astronomy/issues) to make
